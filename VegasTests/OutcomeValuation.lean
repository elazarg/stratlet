...
def graphGame (buyerValue sellerCost : ℝ) : Vegas.Game TestPlayer :=
  SealedOffer.machine.outcomeGame observe (valuation buyerValue sellerCost)
...
def serializedGame (buyerValue sellerCost : ℝ)
    (schedulerUtility : SealedOffer.machine.serializedArena.History → ℝ) :=
  SealedOffer.machine.serializedOutcomeGame observe (valuation buyerValue sellerCost)
    schedulerUtility

def runtimeGame (buyerValue sellerCost : ℝ)
    (schedulerUtility : SealedOffer.machine.serializedArena.History → ℝ) :=
  (Runtime.RequestCompiler.targetGame SealedOffer.machine.serializedArena.information
...
theorem runtime_nash (buyerValue sellerCost : ℝ)
    (schedulerUtility : SealedOffer.machine.serializedArena.History → ℝ)
    (scheduler : SealedOffer.machine.serializedArena.information.BehavioralPolicy .scheduler)
